...
for w in weights:
    for r in runs:
        # path = 'classify_test/ULTRE_train_pl_{}_click/model{}'.format(w, r)
        path = 'classify_test/ULTRE_train_sample_1_svm_click/model{}'.format(r)
        for filename in os.listdir(path):
            ...
            label_file = open('/home/niuzechun/svm_rank/click/test.labels', "r", encoding="utf-8")
            print(w + r + filename)
            ndcg = 0.0
            for i in range(300):
                rel = []
...
workbook.save("ANOVA_test_query_train_sample_1_svm_prs.xls")
